...
def home():
    # index.html fica na mesma pasta do app.py
...
def criar_procedimento():
    ...
    data_publicacao = (data.get("data_publicacao") or "").strip()  # YYYY-MM-DD
    ...
    # validação mínima do depto (pra casar com seu CSS)
    ...
    # validação mínima do formato de data YYYY-MM-DD
...
if __name__ == "__main__":
    ...
    # quando rodar via gunicorn no Render, inicializa também
    init_db()
